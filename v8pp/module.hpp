...
public:
	...
	module& value(string_view const& name, v8::Local<Data> value)
	{
	...
	module& submodule(string_view const& name, v8pp::module& m)
	{
	...
	template<typename T, typename Traits>
	module& class_(string_view const& name, v8pp::class_<T, Traits>& cl)
	{
	...
	module& function(string_view const& name, Function&& func)
	{
	...
	module& const_(string_view const& name, module& m)
	{
		v8::HandleScope scope(isolate_);
	...
	module& const_(string_view const& name, Value const& value)
	{
		v8::HandleScope scope(isolate_);
